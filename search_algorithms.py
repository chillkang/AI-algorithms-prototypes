...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 28 20:40:30 2022
...
#     (x1, x2) = a
#     (y1, y2) = b
#     return D * math.sqrt(abs(x1 - x2) * abs(x1 - x2) + abs(y1 - y2) * abs(y1 - y2))
# 
# =============================================================================
# =============================================================================
# def heuristic(a: GridLocation, b: GridLocation) -> float:
...
# define graph with walls and weighted areas
g = GridWithWeights(30, 30)
g.walls = [(1,28),(2,28),(3,28),(4,28),(5,26),(6,23),(7,23),(8,23),(9,23),(10,24),(11,24),
           (6,28),(7,28),(8,28),(9,28),(10,28),(11,28),(12,28),(12,27),(12,26),(12,25),
           (12,24),(12,23),(12,22),(12,21),(12,20),(12,19),(11,18),(12,18)]
g.weights = {loc: 5 for loc in [(6,22),(7,21),(7,22)]}

# define start/goal locations
start = (2, 29)
goal = (11, 17)
...
# Uniform cost (Dijkstra algorithm) 
